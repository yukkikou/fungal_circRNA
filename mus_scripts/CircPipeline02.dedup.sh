...
workdir=/media/work/hxy/CIRIlong_zfq/2_dedup
outdir=/media/share/node10/disk3/ylab/hxy/CIRIlong_zfq/2_dedup
...
cl1=$workdir/${clean_prefix}_R1.paired.dedup.fq.gz
cl2=$workdir/${clean_prefix}_R2.paired.dedup.fq.gz
...
fastp --in1 $fq1 --in2 $fq2 \
	...
	--dedup --dup_calc_accuracy 6 \
        ...
        -q 20 --length_required 130 --length_limit 160 \
        -w $thread \
...
# work space release
rm $cl1 $cl2 $repdir/${clean_prefix}_fastp.* $logdir/${clean_prefix}.fastp.log
